...
const projectData = [
  ...
  },
  {
    tag: 'Video Editing',
    thumbClass: 'thumb-2',
    title: 'Video Promosi Menu — Kopi Kenangan',
    role: 'Barista & Content Support',
    tools: 'CapCut, Adobe Premiere Rush',
    desc: 'Mengedit video pendek promosi menu andalan store, memadukan footage proses penyajian dengan musik dan teks agar menarik untuk dibagikan ke media sosial.'
  },
  {
  ...
  },
  {
    ...
    desc: 'Mendokumentasikan aktivitas harian store — mulai dari persiapan buka toko hingga interaksi dengan customer — untuk memperkuat kedekatan brand dengan audiens.'
  },
  {
    tag: 'Laporan Visual',
    thumbClass: 'thumb-6',
